...
### Next.js
  - [오류수정](./src/troubleshooting/Next.js/오류수정.md)
### recoil
  - [RecoilRoot 설정 오류](./src/troubleshooting/recoil/RecoilRoot%20설정%20오류.md)
### style
  - [Next.js - Prop `className` did not match className](./src/troubleshooting/style/Next.js%20-%20Prop%20`className`%20did%20not%20match%20className.md)
  - [third party overriding](./src/troubleshooting/style/third%20party%20overriding.md)
  - [http1.1의 MaxConnection 6 제한 해결](./src/troubleshooting/http1.1의%20MaxConnection%206%20제한%20해결.md)
  - [linux-network](./src/troubleshooting/linux-network.md)
  - [yum-proxy-설정](./src/troubleshooting/yum-proxy-설정.md)
## dev_notes
### algorithm

#### 문제풀이
  - [공원산책](./src/dev_notes/algorithm/문제풀이/공원산책.md)
  - [달리기경주](./src/dev_notes/algorithm/문제풀이/달리기경주.md)
  - [추억점수](./src/dev_notes/algorithm/문제풀이/추억점수.md)
  - [heapq](./src/dev_notes/algorithm/heapq.md)
  - [배열](./src/dev_notes/algorithm/배열.md)
  - [버블정렬](./src/dev_notes/algorithm/버블정렬.md)
  - [선택정렬](./src/dev_notes/algorithm/선택정렬.md)
  - [이진탐색](./src/dev_notes/algorithm/이진탐색.md)
  - [전위,중위,후의](./src/dev_notes/algorithm/전위,중위,후의.md)
### cacahe
  - [memcahed-설치](./src/dev_notes/cacahe/memcahed-설치.md)
### CICD
  - [commitlint](./src/dev_notes/CICD/commitlint.md)
  - [jenkins-1](./src/dev_notes/CICD/jenkins-1.md)
### CS
...
### golang
  ...
  - [Tutorial_04](./src/dev_notes/golang/Tutorial_04.md)
  - [Tutorial_05](./src/dev_notes/golang/Tutorial_05.md)
  ...
  - [Tutorial_10](./src/dev_notes/golang/Tutorial_10.md)
...
#### 성능
  ...
  - [css-floxbox란](./src/dev_notes/html-css/css-floxbox란.md)
  - [css-선택자-우선순위](./src/dev_notes/html-css/css-선택자-우선순위.md)
  - [margin-top vs top](./src/dev_notes/html-css/margin-top%20vs%20top.md)
...
### k8s
  - [kubectl install](./src/dev_notes/k8s/kubectl%20install.md)
  - [service](./src/dev_notes/k8s/service.md)
### lint
  - [eslint](./src/dev_notes/lint/eslint.md)
### nextjs
...
### security
  - [DOM-XSS](./src/dev_notes/security/DOM-XSS.md)
  - [fileUpload](./src/dev_notes/security/fileUpload.md)
  - [민감한 데이터를 localstorage에 저장하는 경우](./src/dev_notes/security/민감한%20데이터를%20localstorage에%20저장하는%20경우.md)
### server

#### linux
  - [ios 타입 구분](./src/dev_notes/server/linux/ios%20타입%20구분.md)
  - [ZeroMQ](./src/dev_notes/server/ZeroMQ.md)
### shell
  - [zshell](./src/dev_notes/shell/zshell.md)
### test

#### cypress
  - [E2E-Test-1](./src/dev_notes/test/cypress/E2E-Test-1.md)

#### mock
  - [msw](./src/dev_notes/test/mock/msw.md)

#### storybook
  - [Storybook](./src/dev_notes/test/storybook/Storybook.md)
  - [use hook in stroybook](./src/dev_notes/test/storybook/use%20hook%20in%20stroybook.md)
### typescript
  - [Parameters](./src/dev_notes/typescript/Parameters.md)
  - [satisfies](./src/dev_notes/typescript/satisfies.md)
  - [type vs interface](./src/dev_notes/typescript/type%20vs%20interface.md)
  - [typeof vs keyof](./src/dev_notes/typescript/typeof%20vs%20keyof.md)
### yarn
  - [yarn2](./src/dev_notes/yarn/yarn2.md)
  - [명령어 정리](./src/dev_notes/yarn/명령어%20정리.md)
